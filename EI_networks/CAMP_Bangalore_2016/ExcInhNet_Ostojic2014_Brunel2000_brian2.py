...
el = 24.*mV         # Resting potential
vt = 20.*mV         # Spiking threshold
taum = 20.*ms       # Membrane time constant
vr = 10.*mV         # Reset potential
inp = 0*mV/taum     # input I/C to each neuron
...
P.v = uniform(el/mV,vt/mV,N)*mV
#P.v = linspace(el/mV-20,vt/mV,N)*mV
# instead, below set a small 1mV spread in init v to see 'symm breaking'
# but if you also set taudelay=0, exc neurons won't fire at all.
# with taudelay=0, you should spreadout init v as above.
#P.v = linspace(el/mV-20,el/mV-19,N)*mV
