...
# plasticity on all exc->exc and exc->inh neurons
con_e = Synapses(Pe,neurons,stdp_eqns,\
...
con_e.wsyn = 1. # initial weight - same as line below
#con_e.wsyn = ones(shape(con_e.wsyn))
